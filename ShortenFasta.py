...
#should support splitting multispecies copies into multiple entries
...
class Fasta:
    ...
    def open_seqs(self, fastaname):
        ...
        with open(fastaname) as fastafile:
            ...
            for line in fastafile:
                ...
                if ">" in line:
                    ...
                    multispecies_copies = line.split(">")
                    for seqid in multispecies_copies:

                        newline = seqid.strip()
                        newline = seqid.strip(">")
                        #save the seqID
                        self.new_ids.append(newline)
                    ...
                    num_copies = len(multispecies_copies)
                else:
        ...
        print(str(len(self.original_seqs)))
    ...
    def shorten(self):
        ...
        for i in range(len(self.original_ids)):
            ...
            # this works w old format usually
            if "gi|" in line:
                #get gi num
            ...
            #get acc number from new format
            else:
                #get accession num
