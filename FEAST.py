...
def PfamSelect(info, fasta, directory):
    ...
    if mode == "O":
        ...
        if pfop == 1:
            a = everythingnotlocal1(fasta, 500, domainlist[0], directory)
        if pfop == 2:
            a = everythingnotlocal2(fasta, 500, domainlist[
    ...
    with open(outfile, "w") as new:
        ...
        for line in original:
            ...
            if ok == "yes":
                ...
                edit = re.sub(
                    "(.*)(\t)([0-9][0-9]*\t)([0-9][0-9]*\t)([0-9][0-9]*\t)([0-9][0-9]*\t)([A-Z.0-9]*\t)([^\t]*)(\t)([^\t]*)(.*)", "\\1 \\8", line)
                edit = edit.strip()
                edit = edit+"\n"
            else:
                edit = ""
...
def verifydomain(inputfile, inputdomain):
    ...
    for line in orig:
        try:
            ...
            print("ERROR splitting this line at space")
            print(line)
            continue
        for d in listofinputdomains:
            if str(domain.strip()) in str(d.strip()):
